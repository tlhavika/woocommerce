...
},
{
  ...
  img: "/Bateria de Gel AGM Solar KLC 12V.jpeg",
...
},
{
  ...
  },
  {
    id: "30",
    nomeProduto: "Bateria de Gel AGM Solar KLC 12V",
    img: "/Gel AGM Solar KLC 12V.jpeg",
    descricao: "Bateria Agm de ciclo profundo KLE 12v 100ah 20hr - 4 unidades. Esta bateria é de 12 volts e tem capacidade de 200 A/hora.",
    preco: "12.000,00 Mt (+IVA)",
    categoria: "Bateria",
    propriedades: "Tipo de Baterria: Baterria de Gel",
    propriedades1: "Voltagem Nominal: 12V",
    propriedades2: "Capacidade Nominal: 100 Ah",
  ...
  {
    id: "44",
    nomeProduto: "Motor 1500w",
    img: "/dc-motor-1500.webp",
    descricao: "",
    preco: "34.700,00 Mt (+IVA)",
    categoria: "Motor",
    propriedades: "Tensão: 380V",
    propriedades1: "Potência: 1,5KW 2 HP",
    propriedades2: "Velocidade: 2850 RPM",
...
export default function TodosProdutos() {
  ...
  return (
    <section className="mt-8">
          ...
          ):(<div className="hidden lg:grid sm:grid-cols-9 gap-4 mt-2">
          <div className="shadow-md p-2">
              <div className="text-center text-primary font-semibold"  onClick={() => setCategoriaClicked("Inversor")}>Inversores</div>             
          </div>
          <div className="shadow-md p-2">
